...
class S implements WidgetsLocalizations {
  ...
  String get delete_key_description => "Attention! You'll no longer be able to decrypt encrypted files on this device unless you import this key again.";
  ...
  String get has_PGP_public_key => "Selected recipient has PGP public key. The file can be encrypted using this key.";
  ...
  String get need_to_set_encryption_key => "To start using encryption of uploaded files your need to set any encryption key.";
  ...
  String confirm_delete_pgp_key(String email) => "Are you sure you want to delete OpenPGP key for $email?";
  String downloaded_successfully_into(String name, String path) => "$name downloaded successfully into: $path";
  String downloading(String name) => "Downloading $name";
  String downloading_to(String path) => "Downloading $path";
  String encrypted_using_key(String user) => "The file is encrypted using $user's PGP public key. You can send the link via encrypted email.";
