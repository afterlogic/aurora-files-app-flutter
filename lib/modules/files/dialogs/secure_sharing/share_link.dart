...
class ShareLink extends StatefulWidget {
  ...
  ShareLink(this.file, this.selectRecipientResult, this.filesState);
...
class _ShareLinkState extends State<ShareLink> {
  ...
  void _deleteLink() async {
    ...
    await widget.filesState.updateFile(getCompanionFromLocalFile(
        widget.file.localFile, widget.file.file.path));
  ...
  void _sendTo() async {
    ...
    if (widget.selectRecipientResult.pgpKey != null) {
      pgp.setTempFile(File(widget.file.file.path + ".temp"));
            ...
            ListView(
              children: [
                ...
                if (widget.selectRecipientResult != null) ...[
                  Text(s.recipient),
                  SizedBox(height: 10),
                  RecipientWidget(widget.selectRecipientResult, (_) {
