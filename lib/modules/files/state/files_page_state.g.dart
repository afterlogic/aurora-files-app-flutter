...
mixin _$FilesPageState on _FilesPageState, Store {
   final _$selectedFilesIdsAtom =
      Atom(name: '_FilesPageState.selectedFilesIds');
  ...
  set selectedFilesIds(Map<String, dynamic> value) {
   ...
   final _$isSearchModeAtom =
      Atom(name: '_FilesPageState.isSearchMode');
  ...
  set isSearchMode(bool value) {
   ...
   final _$filesLoadingAtom =
      Atom(name: '_FilesPageState.filesLoading');
